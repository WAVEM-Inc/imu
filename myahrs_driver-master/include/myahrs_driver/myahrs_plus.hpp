 ...
 **********************************************************************************************************/
    ...
    private:
        ...
        bool ascii_update_quaternion(std::vector<std::string>& tokens) {
            //ROS_ERROR("ascii_update_quaternion");
        ...
        bool ascii_update_quatimu(std::vector<std::string>& tokens) {
            //ROS_ERROR("ascii_update_quatimu");
        ...
        bool binary_parse_response(std::vector<iNodeParser::Node>& node_list) {
            //ROS_ERROR("binary_parse_response");
            LockGuard _l(mutex_attribute);
            ...
            for(size_t i=0; i<node_list.size(); i++) {
                ...
                //ROS_ERROR("node.name[%d] : %s", i, node.name.c_str());
        ...
        bool binary_update_euler(iNodeParser::Node& node) {
            ...
            //ROS_ERROR("yawhpp : %f", yaw);
            //ROS_ERROR("binary : %d", node.list[2].value.i16);
        ...
        bool binary_update_quaternion(iNodeParser::Node& node) {
            //ROS_ERROR("binary_update_quaternion");
            static const int DATA_NUM = 4;
            if(node.list.size() != DATA_NUM) {
                return false;
            }
        ...
        bool binary_update_imu(iNodeParser::Node& node) {
            ...
            //ROS_ERROR("node[2] : %d", node.list[2].value.i16);
            //ROS_ERROR("m[5] : %f", m[5]);
//            ROS_ERROR("node[6] : %d", node.list[6].value.i16);
//            ROS_ERROR("node[7] : %d", node.list[7].value.i16);
//            ROS_ERROR("node[8] : %d", node.list[8].value.i16);

//            for(int i=0;i<10;i++){
//                ROS_ERROR("node[%d] : %d", i, node.list[i].value.i16);
//            }
